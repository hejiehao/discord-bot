...
@app_commands.describe(
    user='The User you want to ping',
    times='the times you want to ping'
)
async def ping(interaction: discord.Interaction, user: discord.Member, times: Optional[int] = 1):
    """ping a person"""
...
@client.tree.command()
@app_commands.rename(text_to_send='text')
@app_commands.describe(text_to_send='Text to send in the current channel secretly')
